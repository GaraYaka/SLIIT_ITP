        ...
        <div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								</div></div></div><div class="table-scrollable"><table class="table table-striped table-bordered table-hover dataTable no-footer" id="datatable_ajax" aria-describedby="datatable_ajax_info" role="grid">
								<thead>
								<tr role="row" class="heading"><th width="2%" class="sorting_disabled" rowspan="1" colspan="1">
									...
									</th><th width="5%" class="sorting" tabindex="0" aria-controls="datatable_ajax" rowspan="1" colspan="1">
										 Vehicle&nbsp;#
									</th><th width="15%" class="sorting" tabindex="0" aria-controls="datatable_ajax" rowspan="1" colspan="1">
										 Model
									</th><th width="15%" class="sorting" tabindex="0" aria-controls="datatable_ajax" rowspan="1" colspan="1">
										 Year
									</th><th width="10%" class="sorting" tabindex="0" aria-controls="datatable_ajax" rowspan="1" colspan="1">
										 Registration number
									</th><th width="10%" class="sorting" tabindex="0" aria-controls="datatable_ajax" rowspan="1" colspan="1">
										 Province
									</th><th width="10%" class="sorting" tabindex="0" aria-controls="datatable_ajax" rowspan="1" colspan="1">
