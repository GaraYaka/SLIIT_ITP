...
<body class="login">
    ...
    <!-- BEGIN LOGO -->
    <div class="logo">
        <a href="https://github.com/GaraYaka/SLIIT">
            <img src="../../Images/metronicwihouterp.png" alt="" />
        </a>
    </div>
    <!-- END LOGO -->
    ...
    <div class="content">
        ...
        <form class="login-form" action="index.html" method="post">
            ...
            <div class="form-group">
                <label class="badge badge-roundless badge-danger" id="lblIncorrectCredentails"></label>
            </div>
